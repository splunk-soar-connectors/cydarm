...
[comment]: # ""
-   Built against Cydarm API Version: 0.8.30
-   See Cydarm API documentation: [here.](https://support.cydarm.com/en/knowledge/api-documentation)
-   Each action corresponds to a respective API endpoint.
-   Some actions and endpoints are only partially implemented in terms of supported parameters. Also
    some endpoints have only a subset of output fields mapped.


### Configuration Variables
The below configuration variables are required for this Connector to operate.  These variables are specified when configuring a Cydarm asset in SOAR.
...
action_result.parameter.case_uuid | string |  |  
...
--------- | ---- | -------- | --------------
action_result.status | string |  |   success  failed 
action_result.parameter.action_instance_uuid | string |  |  
...
action_result.parameter.uuid | string |  |  
action_result.data.\*.acl | string |  |  
action_result.data.\*.uuid | string |  |  
action_result.summary | string |  |  
action_result.message | string |  |  
...
action_result.status | string |  |   success  failed 
action_result.parameter.case_uuid | string |  |  
action_result.parameter.playbook_uuid | string |  |  
action_result.data.\*.acl | string |  |  
action_result.data.\*.uuid | string |  |  
action_result.summary | string |  |  
action_result.message | string |  |  
...
--------- | ---- | -------- | --------------
action_result.status | string |  |   success  failed 
action_result.parameter.case_playbook_uuid | string |  |  
action_result.parameter.case_uuid | string |  |  
...
--------- | ---- | -------- | --------------
action_result.status | string |  |   success  failed 
action_result.parameter.action_uuid | string |  |  
...
--------- | ---- | -------- | --------------
action_result.status | string |  |   success  failed 
action_result.parameter.acl_uuid | string |  |  
...
--------- | ---- | -------- | --------------
action_result.status | string |  |   success  failed 
action_result.parameter.user_uuid | string |  |  
...
action_result.status | string |  |   success  failed 
action_result.parameter.case_uuid | string |  |  
action_result.parameter.member_case_uuid | string |  |  
action_result.data.\*.acl | string |  |  
action_result.data.\*.uuid | string |  |  
action_result.summary | string |  |  
action_result.message | string |  |  
